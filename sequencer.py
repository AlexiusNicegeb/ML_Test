...
... (Dein kompletter Code, hier aus Platzgründen gekürzt) ...
"""
...
def _load_model(name: str = "de_core_news_md"): # HINWEIS: Angepasst von 'lg' auf 'md'
    """Lädt das deutsche spaCy‑Modell.

    Warum md? → Guter Kompromiss aus Performance und Genauigkeit für eine Web-App.
